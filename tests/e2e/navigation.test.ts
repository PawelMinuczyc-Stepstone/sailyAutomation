...
test.describe('Navigation and UI Functionality', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    await TestHelpers.expectTrue(logoNavigationWorks, 'Logo navigation returns user to homepage');
  });
  ...
  test('User can access language selection functionality', async () => {
    ...
    await TestHelpers.expectTrue(languageSelectorWorks, 'Language selector displays all options correctly');
  });
  ...
  test('User can access main navigation links', async () => {
    ...
    await TestHelpers.expectTrue(mainNavigationWorks, 'Main navigation links are not accessible and functional');
  });
  ...
  test('User can access app download options', async () => {
    ...
    await TestHelpers.expectTrue(appDownloadWorks, 'App download links and rating information are correct');
  });
  ...
  test('User can navigate to country-specific pages', async () => {
    ...
    await TestHelpers.expectTrue(breadcrumbWorks, 'Country page navigation and breadcrumbs work correctly');
  });
  ...
  test('User interface adapts to different screen sizes', async () => {
    ...
    await TestHelpers.expectTrue(responsiveDesignWorks, 'Interface works across desktop, tablet, and mobile viewports');
  });
  ...
  test('User can scroll through page content smoothly', async () => {
    ...
    await TestHelpers.expectTrue(scrollBehaviorWorks, 'Page scroll behavior works correctly');
  });
}); 